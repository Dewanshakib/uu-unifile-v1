...
import { updateGoogleClassroom } from "@/actions/google-classroom";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function EditGoogleClassroomForm({
  subjects,
  googleClassroom,
}: GoogleClassroomProps & { googleClassroom: IGoogleClassroom }) {
  ...
  const {
    ...
    mode: "onChange",
    defaultValues: {
      course: googleClassroom.course,
      code: googleClassroom.code,
      instructor: googleClassroom.instructor,
      subject: googleClassroom.subject,
      section: googleClassroom.section,
      semester: googleClassroom.semester.toString(),
      year: googleClassroom.year.toString(),
    },
  });
  ...
  const onSubmit = async (data: GoogleClassroomInput) => {
    try {
      ...
      await updateGoogleClassroom(googleClassroom.id, formData);

      toast.success("Google Classroom updated successfully!");
      router.push("/dashboard/google-classroom");
    } catch (error) {
      toast.error(
